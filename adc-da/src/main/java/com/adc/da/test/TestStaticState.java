...
public class TestStaticState {
    public static void main(String[] args) throws Exception {
        ...
        staticStream.map(new RichMapFunction<OdsData[], String>() {
        ...
        staticStream.map(new MapFunction<OdsData[], String>() {
            @Override
            public String map(OdsData[] odsData) throws Exception {
                return  odsData[0].getMsgTime()+"  "+odsData[1].getMsgTime();
            }
        }).print();

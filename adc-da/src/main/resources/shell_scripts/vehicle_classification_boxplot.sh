...
(
    ...
    from
        ...
        from avg_vehicle_data_perday avdp join diff_Voltage_info dvi
...
(
    ...
    from
        ...
        from avg_vehicle_data_perday avdp join diff_temper_info dti
...
(
    ...
    from
        ...
        from avg_vehicle_data_perday avdp join temper_rate_info tri
...
(
    ...
    from
        ...
        from avg_vehicle_data_perday avdp join temper_info ti
...
(
    ...
    from
        ...
        from avg_vehicle_data_perday avdp join resistance_info ri
...
(
    ...
    from
        ...
        from avg_vehicle_data_perday avdp join wDischargeRate_info wi
